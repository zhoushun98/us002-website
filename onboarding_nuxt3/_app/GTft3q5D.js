...
*   Note that some cookies are strictly necessary for the Site to function and therefore cannot be disabled`
    ...
    tiers: {
      ...
      tierOneCryptoWithdrawalBlock: {
        ...
        provideProofOfIdentity: "Provide proof of your identity for unlimited crypto withdrawals and additional features.",
        verifyIDButton: "Verify my ID"
      },
      tierOneFeatureBlock: {
        blockTitle: "This feature is available only when you verify your ID.",
        verifyIDDisclaimer: "Verify your ID to access this feature.",
        moreInfoLink: "More Info.",
        verifyIDButton: "Verify my ID"
      }
    },
